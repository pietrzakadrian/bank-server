...
export class CreateTables1586258934765 implements MigrationInterface {
    name = 'CreateTables1586258934765'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "currency" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "current_exchange_rate" integer NOT NULL, "main" boolean NOT NULL DEFAULT false, "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_3cda65c731a6264f0e444cc9b91" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "users_config" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "notification_status" boolean NOT NULL DEFAULT false, "notification_count" integer NOT NULL DEFAULT 0, "message_status" boolean NOT NULL DEFAULT false, "message_count" integer NOT NULL DEFAULT 0, "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "user_id" integer NOT NULL, CONSTRAINT "REL_6deb66d33458d7afbf9ae3efd7" UNIQUE ("user_id"), CONSTRAINT "PK_b529cae1138818ca95223e95db8" PRIMARY KEY ("id"))`, undefined);
